...
\begin{Slide}{AdaBoost}
	\begin{itemize}
		...
		\item Este é um vídeo que explica de forma muito didática como o algoritmo Adaboost funciona: \textbf{https://www.youtube.com/watch?v=LsK-xG1cLYA}
		
		\item Esta é uma aula do professor Patrick Winston no curso de Inteligência Artificial do MIT: \textbf{https://www.youtube.com/watch?v=UHBmv7qCey4} Explica de uma maneira mais formal como a ideia de Boosting funciona.
...
\begin{Slide}{Gradient Boost para problemas de regressão}
	\begin{itemize}
		...
		\item Outro vídeo que explica de forma muito didática como o algoritmo em questão funciona: \textbf{https://www.youtube.com/watch?v=3CC4N4z3GJc}
...
\begin{Slide}{Referências}
	\begin{itemize}
		\item https://scikit-learn.org/stable/modules/ensemble.html\#adaboost
		\item AdaBoost: https://www.youtube.com/watch?v=LsK-xG1cLYA
		\item Learning: Boosting. MIT 6.034 Artificial Intelligence, Fall 2010. Instructor: Patrick Winston. https://www.youtube.com/watch?v=UHBmv7qCey4
		\item 
	\end{itemize}
\end{Slide}
