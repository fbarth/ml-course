...
\begin{Slide}{Cálculo da distância e identificação do exemplo mais próximo}
	\centering 
...
\begin{Slide}{Cuidado: normalizar dados}
	...
	\begin{itemize}
		...
		\item Ao utilizar o pacote $sklearn.preprocessing.MinMaxScaler$, a transformação implementada é: 
